...
class ITKLevelSetsv4_TEMPLATE_EXPORT LevelSetEvolutionComputeIterationThreader
{};
...
class ITKLevelSetsv4_TEMPLATE_EXPORT LevelSetEvolutionComputeIterationThreader< LevelSetDenseImage< TImage >, ThreadedImageRegionPartitioner< TImage::ImageDimension >, TLevelSetEvolution >
...
template< typename TImage, typename TLevelSetEvolution >
class ITKLevelSetsv4_TEMPLATE_EXPORT LevelSetEvolutionComputeIterationThreader< LevelSetDenseImage< TImage >,
