...
class ITKLevelSetsv4_TEMPLATE_EXPORT BinaryImageToLevelSetImageAdaptor
{};
...
class ITKLevelSetsv4_TEMPLATE_EXPORT BinaryImageToSparseLevelSetImageAdaptorBase :
