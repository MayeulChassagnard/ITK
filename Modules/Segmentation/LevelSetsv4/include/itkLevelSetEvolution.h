...
class ITKLevelSetsv4_TEMPLATE_EXPORT LevelSetEvolution
{};

template< typename TEquationContainer, typename TImage >
class ITKLevelSetsv4_TEMPLATE_EXPORT LevelSetEvolution<  TEquationContainer,
...
class ITKLevelSetsv4_TEMPLATE_EXPORT LevelSetEvolution< TEquationContainer, WhitakerSparseLevelSetImage< TOutput, VDimension > > :
