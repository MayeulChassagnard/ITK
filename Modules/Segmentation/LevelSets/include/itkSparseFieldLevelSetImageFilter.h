...
class ITKLevelSets_TEMPLATE_EXPORT SparseFieldLevelSetNode
{
public:
  TValue               m_Value;
...
class ITKLevelSets_TEMPLATE_EXPORT SparseFieldCityBlockNeighborList
{
public:
...
class ITKLevelSets_TEMPLATE_EXPORT SparseFieldLevelSetImageFilter:
