...
class ITKLevelSetsv4Visualization_TEMPLATE_EXPORT VTKVisualizeImageLevelSetIsoValues
{};
...
class ITKLevelSetsv4Visualization_TEMPLATE_EXPORT VTKVisualizeImageLevelSetIsoValues< Image< TInputPixel, 2 >, TLevelSet >
 ...
 */
template< typename TInputPixel, typename TLevelSet >
class ITKLevelSetsv4Visualization_TEMPLATE_EXPORT VTKVisualizeImageLevelSetIsoValues< Image< TInputPixel, 3 >, TLevelSet >
  : public VTKVisualizeImageLevelSet<
      Image< TInputPixel, 3 >,
