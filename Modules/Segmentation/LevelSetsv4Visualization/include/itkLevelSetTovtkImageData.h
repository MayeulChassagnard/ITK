...
class ITKLevelSetsv4Visualization_TEMPLATE_EXPORT LevelSetTovtkImageData
  {};
...
class ITKLevelSetsv4Visualization_TEMPLATE_EXPORT LevelSetTovtkImageData< LevelSetDenseImage< TImage > > :
...
class ITKLevelSetsv4Visualization_TEMPLATE_EXPORT LevelSetTovtkImageData< WhitakerSparseLevelSetImage< TOutput, VDimension > > :
...
class ITKLevelSetsv4Visualization_TEMPLATE_EXPORT LevelSetTovtkImageData< ShiSparseLevelSetImage< VDimension > > :
...
// -----------------------------------------------------------------------------
template< unsigned int VDimension >
class ITKLevelSetsv4Visualization_TEMPLATE_EXPORT LevelSetTovtkImageData< MalcolmSparseLevelSetImage< VDimension > > :
