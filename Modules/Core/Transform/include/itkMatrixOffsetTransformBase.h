...
template <>
class ITKTransform_TEMPLATE_EXPORT MatrixOrthogonalityTolerance<double>
{
public:
...
template <>
class ITKTransform_TEMPLATE_EXPORT MatrixOrthogonalityTolerance<float>
{
public:
...
class ITKTransform_TEMPLATE_EXPORT MatrixOffsetTransformBase :
