...
class ITKCommon_TEMPLATE_EXPORT MapFileParser
{
public:
...
class ITKCommon_TEMPLATE_EXPORT SmapsFileParser:public MapFileParser< TSmapsDataType >
{
public:
...
class ITKCommon_TEMPLATE_EXPORT VMMapFileParser:public MapFileParser< TVMMapDataType >
{
public:
