...
class ITKGPUCommon_TEMPLATE_EXPORT GPUImage : public Image<TPixel,VImageDimension>
{
public:
...
class ITKGPUCommon_TEMPLATE_EXPORT GPUImageFactory : public itk::ObjectFactoryBase
{
public:
...
template <typename T>
class ITKGPUCommon_TEMPLATE_EXPORT GPUTraits
{
public:
  typedef T Type;
};
...
class ITKGPUCommon_TEMPLATE_EXPORT GPUTraits< Image< TPixelType, NDimension > >
{
public:
