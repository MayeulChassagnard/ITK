...
class ITKQuadEdgeMesh_TEMPLATE_EXPORT QuadEdgeMeshFrontBaseIterator
{
public:
 ...
 */
template< typename TMesh, typename TQE >
class ITKQuadEdgeMesh_TEMPLATE_EXPORT QuadEdgeMeshFrontIterator:
...
class ITKQuadEdgeMesh_TEMPLATE_EXPORT QuadEdgeMeshConstFrontIterator:
  public QuadEdgeMeshFrontBaseIterator< TMesh, TQE >
{
public:
  /** Hierarchy typedefs & values. */
