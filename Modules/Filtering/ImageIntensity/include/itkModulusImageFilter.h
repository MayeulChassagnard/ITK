...
class ITKImageIntensity_TEMPLATE_EXPORT Modulus
{
public:
  Modulus() {  }
  ~Modulus() {}
...
class ITKImageIntensity_TEMPLATE_EXPORT ModulusTransform
{
public:
...
class ITKImageIntensity_TEMPLATE_EXPORT ModulusImageFilter:
  public
