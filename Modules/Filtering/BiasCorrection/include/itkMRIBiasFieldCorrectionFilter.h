...
class ITKBiasCorrection_TEMPLATE_EXPORT MRIBiasEnergyFunction : public SingleValuedCostFunction
{
public:
...
class ITKBiasCorrection_TEMPLATE_EXPORT MRIBiasFieldCorrectionFilter :
