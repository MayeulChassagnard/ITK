...
class ITKDeconvolution_TEMPLATE_EXPORT ParametricBlindLeastSquaresDeconvolutionImageFilter :
...
private:
  ...
  template< typename TPixel >
    class ITKDeconvolution_TEMPLATE_EXPORT ParametricBlindLeastSquaresDeconvolutionDifference
  {
  public:
  ...
  template< typename TPixel >
    class ITKDeconvolution_TEMPLATE_EXPORT ParametricBlindLeastSquaresDeconvolutionImageUpdate
  {
  public:
